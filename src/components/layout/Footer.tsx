      ...
      <div className="py-8">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-6 border-b border-gray-200/60 dark:border-gray-700/30">
          ...
          <article className="space-y-3">
            <Logo />
            <p className={cn(textSize('small'), 'text-gray-500 dark:text-gray-400 max-w-md')}>
          ...
          <aside className="flex flex-col items-start md:items-end space-y-3">
            <div className="flex items-center gap-3">
              <a
                href="https://forms.gle/HVbyfxRUrczPgY4M7"
                target="_blank"
                ...
                aria-label="Report an issue on Google Forms"
                tabIndex={0}
              >
                <svg
            ...
            <div className="flex items-center gap-1.5">
              <span className={cn(textSize('tiny'), 'text-gray-500 dark:text-gray-400')}>
                Built with
              </span>
              <svg
              ...
              <span className={cn(textSize('tiny'), 'text-gray-500 dark:text-gray-400')}>by</span>
              <a
                href="https://github.com/SaiRev0"
                target="_blank"
                rel="noopener noreferrer"
                className={cn(linkStyles('primary'), textSize('tiny'))}
                aria-label="Visit Saiyam Jain's GitHub profile"
                tabIndex={0}
              >
                Saiyam (SaiRev0)
              </a>
        ...
        <section className="pt-4 flex flex-col sm:flex-row justify-between items-center">
          <p className={cn(textSize('tiny'), 'text-gray-500 dark:text-gray-400')}>
            <small>
