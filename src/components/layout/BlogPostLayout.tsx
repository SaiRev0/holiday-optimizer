      ...
      <PageContent>
        <div className="container mx-auto flex flex-col lg:flex-row gap-8 px-4">
            ...
            <div className="sticky top-24">
              ...
              <div ref={shareButtonRef} className="mb-8">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  >
                    {copied ? <CheckCheck className="h-5 w-5 text-green-600 dark:text-green-500" /> :
          ...
          <main className="flex-1 max-w-3xl order-1 lg:order-2">
            {/* AI Content Indicator - more subtle than the full disclaimer banner */}
            <AIContentIndicator />

            <article id="blog-content" ref={articleRef}
                     className="prose prose-slate prose-headings:scroll-mt-24 dark:prose-invert lg:prose-lg max-w-none">
              {children}
            </article>
            ...
            <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
              ...
              <p className="mt-4 text-gray-600 dark:text-gray-300">
                I'm passionate about helping professionals optimize their work-life balance through strategic planning
                and efficient use of time off. This tool was built to share what I've learned about maximizing time away
                from work.
              </p>
            </div>
            ...
            {/* CTA Section */}
            <div
              className="mt-16 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-8 text-center shadow-sm">
